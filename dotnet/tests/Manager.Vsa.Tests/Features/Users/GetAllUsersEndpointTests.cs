...
public class GetAllUsersEndpointTests : IAsyncLifetime
{
    private readonly CreateUserWebApplicationFactory _factory;
    private readonly HttpClient _client;

    public GetAllUsersEndpointTests(PostgresFixture postgres)
    {
    ...
    public async Task GetUsers_AfterCreateUser_IncludesNewUser()
    {
        ...
        var token = _factory.IssueToken(adminId, "getall-cache-admin@example.com");
