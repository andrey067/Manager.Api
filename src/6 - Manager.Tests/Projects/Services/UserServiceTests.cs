...
namespace Manager.Tests.Projects.Services
{
    public class UserServiceTests
    {
        ...
        private readonly Mock<IArgon2IdHasher> _argon2IdHasher;
        ...
        public UserServiceTests()
        {
            ...
            _argon2IdHasher = new Mock<IArgon2IdHasher>();
            _mediatorHandler = new Mock<IMediatorHandler>();

            _sut = new UserService(
                mapper: _mapper,
                userRepository: _userRepositoryMock.Object,
                argon2IdHasher: _argon2IdHasher.Object,
        ...
        public async Task Create_WhenUserIsValid_ReturnsUserDTO()
        {
            ...
            //_argon2IdHasher.Setup(x => x.Invoking(It.IsAny<string>()))
        ...
        public async Task Update_WhenUserIsValid_ReturnsUserDTO()
        {
            ...
            //_argon2IdHasher.Setup(x => x.Encrypt(It.IsAny<string>()))
            //    .Returns(encryptedPassword);
